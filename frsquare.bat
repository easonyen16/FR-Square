...
:: Audio
aria2c --file-allocation=none "https://fr-vod-sni.akamaized.net/%MovieNum%_tracking_0%Version%/1000//audio_128000/playlist.m3u8"
aria2c --file-allocation=none "https://fr-vod-sni.akamaized.net/%MovieNum%_tracking_0%Version%/1000/audio_128000/audio_128000/128000.ts"
:: sed 's?原字符串?替换字符串?'
...
:loop
echo %cnt%
aria2c --file-allocation=none "https://fr-vod-sni.akamaized.net/%MovieNum%_tracking_0%Version%/100%cnt%/video_1705032704/playlist.m3u8"
aria2c --file-allocation=none "https://fr-vod-sni.akamaized.net/%MovieNum%_tracking_0%Version%/100%cnt%/video_1705032704/video_1705032704/1705032704.ts"
